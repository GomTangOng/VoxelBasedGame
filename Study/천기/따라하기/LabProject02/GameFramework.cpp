...
CGameFramework::CGameFramework() {
	...
	m_hFenceEvent = NULL; m_pd3dFence = NULL; m_nFenceValue = 0;
...
void CGameFramework::CreateDirect3DDevice() {
	...
	d3dMsaaQualityLevels.Format = DXGI_FORMAT_R8G8B8A8_UNORM; d3dMsaaQualityLevels.SampleCount = 4; //Msaa4x 다중 샘플링 
...
void CGameFramework::FrameAdvance() {
	...
	ProcessInput();
	AnimateObjects();
	HRESULT hResult = m_pd3dCommandAllocator->Reset(); hResult = m_pd3dCommandList->Reset(m_pd3dCommandAllocator, NULL); //명령 할당자와 명령 리스트를 리셋한다.
...
#if def_WITH_ONLY_RESIZE_BACKBUFFERS 
		DXGI_SWAP_CHAIN_DESC dxgiSwapChainDesc;
